...
export const ReactIcon:React.FC<IconsProps> = ({className="", ...props}) => (
  <svg
    ...
    strokeMiterlimit="2"
    clipRule="evenodd"
    viewBox="0 0 128 128" className={`${className}`}
    {...props}
  >
...
export const CSSIcon:React.FC<IconsProps> = ({className="", ...props}) => (
  <svg
    ...
    version="1"
    viewBox="0 0 32 32"
    xmlSpace="preserve" className={`${className}`}
    {...props}
  >
    <path
      fill="#1F62AE"
...
export const JSIcon:React.FC<IconsProps> = ({className="", ...props}) => (
  <svg
    ...
    height="16"
    fill="currentColor"
    viewBox="0 0 16 16" className={`${className}`} {...props}
  >
    <path
      fillRule="evenodd"
      d="M14 4.5V14a2 2 0 01-2 2H8v-1h4a1 1 0 001-1V4.5h-2A1.5 1.5 0 019.5 3V1H4a1 1 0 00-1 1v9H2V2a2 2 0 012-2h5.5L14 4.5zM3.186 15.29a1.176 1.176 0 01-.111-.449h.765a.578.578 0 00.255.384c.07.049.153.087.249.114.095.028.202.041.319.041.164 0 .302-.023.413-.07a.559.559 0 00.255-.193.507.507 0 00.085-.29.387.387 0 00-.153-.326c-.101-.08-.255-.144-.462-.193l-.619-.143a1.72 1.72 0 01-.539-.214 1.001 1.001 0 01-.351-.367 1.068 1.068 0 01-.123-.524c0-.244.063-.457.19-.639.127-.181.303-.322.528-.422.224-.1.483-.149.776-.149.305 0 .564.05.78.152.216.102.383.239.5.41.12.17.186.359.2.566h-.75a.56.56 0 00-.12-.258.624.624 0 00-.247-.181.923.923 0 00-.369-.068c-.217 0-.388.05-.513.152a.472.472 0 00-.184.384c0 .121.048.22.143.3a.97.97 0 00.405.175l.62.143c.218.05.406.12.566.211.16.09.285.21.375.358.09.148.135.335.135.56 0 .247-.063.466-.188.656a1.216 1.216 0 01-.539.439c-.234.105-.52.158-.858.158-.254 0-.476-.03-.665-.09a1.404 1.404 0 01-.478-.252 1.13 1.13 0 01-.29-.375zm-3.104-.033A1.32 1.32 0 010 14.791h.765a.576.576 0 00.073.27.499.499 0 00.454.246c.19 0 .33-.055.422-.164.092-.11.138-.265.138-.466v-2.745h.79v2.725c0 .44-.119.774-.357 1.005-.236.23-.564.345-.984.345a1.59 1.59 0 01-.569-.094 1.145 1.145 0 01-.407-.266 1.14 1.14 0 01-.243-.39z"
    ></path>
  </svg>
)
...
export const PHPIcon:React.FC<IconsProps> = ({className="", ...props}) => (
  ...
  >
    <path
      fill="#007AFF"
      d="M256.001 147.109c123.192 0 217.923 51.893 217.923 108.89S379.12 364.89 256.001 364.89c-123.194 0-217.925-51.894-217.925-108.891s94.802-108.89 217.925-108.89m0-12.075c-127.004 0-230 54.121-230 120.965s102.996 120.967 230 120.967c127.003 0 229.998-54.123 229.998-120.967S383.004 135.034 256.001 135.034zm-73.17 111.262c-5.677 29.109-25.73 26.09-50.384 26.09l9.847-50.744c27.313.001 45.856-2.946 40.537 24.654zm-86.824 77.48h26.378l6.254-32.199c29.54 0 47.867 2.157 64.83-13.728 18.759-17.251 23.646-47.941 10.278-63.322-6.971-8.05-18.185-12.003-33.421-12.003H119.51L96.007 323.776zm133.471-153.523h26.235l-6.254 32.199c22.64 0 43.628-1.653 53.763 7.691 10.638 9.775 5.535 22.281-5.966 81.291h-26.594c11.069-57.068 13.154-61.812 9.128-66.125-3.88-4.168-12.722-3.306-34.068-3.306l-13.513 69.431h-26.234l23.503-121.181zm159.491 76.043c-5.751 29.542-26.379 26.09-50.385 26.09l9.847-50.744c27.456.001 45.856-2.946 40.538 24.654zm-86.824 77.48h26.449l6.254-32.199c31.049 0 48.227 1.796 64.83-13.728 18.759-17.251 23.646-47.941 10.279-63.322-6.974-8.05-18.186-12.003-33.423-12.003h-50.816l-23.573 121.252z"
    ></path>
  </svg>
)
